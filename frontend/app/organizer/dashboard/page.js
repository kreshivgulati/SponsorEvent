...
const slides = [
  {
    ...
    description:
      "Your privacy is our priority. We use the latest encryption technology to protect your data.",
    button: "LEARN MORE",
  ...
  },
  {
    ...
    description:
      "Reach the right sponsors and negotiate partnerships that match your event goals.",
    button: "FIND SPONSORS",
  ...
  },
  {
    ...
    title: "Find Events",
    description:
      "Increase visibility and funding by connecting your event with the perfect brands.",
              ...
              <div className="grid md:grid-cols-2 gap-10 items-center">
                ...
                <div>
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    Our platform manages the entire sponsorship process from
                    discovery to secure payment.
                  </p>
            ...
            <section id="connect-sponsors" className="py-24">
              <div className="grid md:grid-cols-2 gap-10 items-center">
                ...
                <div>
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    Connect directly with sponsors to negotiate terms.
                  </p>
            ...
            <section id="find-events" className="py-24">
              <div className="grid md:grid-cols-2 gap-10 items-center">
                ...
                <div>
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    Discover thousands of targeted sponsorship opportunities.
                  </p>
